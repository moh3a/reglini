        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel
                  className={`w-full max-w-xl transform align-middle transition-all`}
                >
                  <form
                    onSubmit={submitHandler}
                    className={`relative m-auto w-full max-w-xl bg-white dark:bg-grim ${ROUNDED}`}
                  >
                    <input
                      ...
                      autoComplete="off"
                    />
                    <div className="absolute left-1 top-1.5 select-none">
                      <img
